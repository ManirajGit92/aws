...
source "amazon-ebs" "ubuntu" {
  ami_name = "sloopstash-amazon-ubuntu-v1.1.1-ami"
  region = var.region
  ...
  ssh_timeout = "1m"
  tags = {
    Name = "sloopstash-amazon-ubuntu-v1.1.1-ami"
    Region = var.region
...
build {
  name = "ec2_amazon_ubuntu_ami"
  sources = ["source.amazon-ebs.ec2_amazon_ubuntu_inst"]
  provisioner "shell" {
    only = ["amazon-ebs.ec2_amazon_ubuntu_inst"]
